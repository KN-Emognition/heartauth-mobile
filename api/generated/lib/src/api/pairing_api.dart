...
class PairingApi {
  ...
  Future<Response<void>> externalPairingConfirm({
    ...
    final _path = r'/external/v1/pair/exchange/confirm';
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<PairingInitResponse>> externalPairingInit({
    ...
    final _path = r'/external/v1/pair/exchange/init';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
