...
///
/// Properties:
/// * [deviceId] - Stable device identifier under your scheme.
/// * [displayName]
/// * [publicKeyPem] - PEM-encoded P-256 public key generated in hardware-backed keystore.
/// * [fcmToken] - Firebase Cloud Messaging token for the app instance.
/// * [platform]
/// * [osVersion]
/// * [model]
/// * [attestation]
...
abstract class PairingInitRequest
  ...
  /// Stable device identifier under your scheme.
  ...
  /// PEM-encoded P-256 public key generated in hardware-backed keystore.
  @BuiltValueField(wireName: r'publicKeyPem')
  String get publicKeyPem;

  /// Firebase Cloud Messaging token for the app instance.
  @BuiltValueField(wireName: r'fcmToken')
  String get fcmToken;

  @BuiltValueField(wireName: r'platform')
  PairingInitRequestPlatformEnum get platform;
...
class _$PairingInitRequestSerializer
  ...
  Iterable<Object?> _serializeProperties(
    ...
    yield serializers.serialize(
      object.platform,
      specifiedType: const FullType(PairingInitRequestPlatformEnum),
    );
      ...
      switch (key) {
        ...
        case r'platform':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType(PairingInitRequestPlatformEnum),
          ) as PairingInitRequestPlatformEnum;
...
class PairingInitRequestPlatformEnum extends EnumClass {
  @BuiltValueEnumConst(wireName: r'ANDROID')
  static const PairingInitRequestPlatformEnum ANDROID =
      _$pairingInitRequestPlatformEnum_ANDROID;
  @BuiltValueEnumConst(wireName: r'IOS')
  static const PairingInitRequestPlatformEnum IOS =
      _$pairingInitRequestPlatformEnum_IOS;

  static Serializer<PairingInitRequestPlatformEnum> get serializer =>
      _$pairingInitRequestPlatformEnumSerializer;

  const PairingInitRequestPlatformEnum._(String name) : super(name);

  static BuiltSet<PairingInitRequestPlatformEnum> get values =>
      _$pairingInitRequestPlatformEnumValues;
  static PairingInitRequestPlatformEnum valueOf(String name) =>
      _$pairingInitRequestPlatformEnumValueOf(name);
}
