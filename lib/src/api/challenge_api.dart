...
import 'package:heartauth_mobile/src/api_util.dart';
...
class ChallengeApi {
  ...
  Future<Response<void>> completeChallenge({
    required String id,
    required CompleteChallengeRequest completeChallengeRequest,
    ...
    final _path = r'/mobile/v1/challenge/{id}/complete'.replaceAll(
        '{' r'id' '}',
    ...
    try {
      const _type = FullType(CompleteChallengeRequest);
      _bodyData = _serializers.serialize(completeChallengeRequest,
          specifiedType: _type);
