...
class PairingApi {
  ...
  Future<Response<void>> completePairing({
    required CompletePairingRequest completePairingRequest,
    ...
    final _path = r'/mobile/v1/pairing/complete';
    ...
    try {
      const _type = FullType(CompletePairingRequest);
      _bodyData =
          _serializers.serialize(completePairingRequest, specifiedType: _type);
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [InitPairingResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<InitPairingResponse>> initPairing({
    required InitPairingRequest initPairingRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/mobile/v1/pairing/init';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(InitPairingRequest);
      _bodyData =
          _serializers.serialize(initPairingRequest, specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
          _dio.options,
    ...
    InitPairingResponse? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(InitPairingResponse),
            ) as InitPairingResponse;
    } catch (error, stackTrace) {
      throw DioException(
    ...
    return Response<InitPairingResponse>(
      data: _responseData,
