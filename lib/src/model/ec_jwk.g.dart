...
final BuiltSet<ECJwkKtyEnum> _$eCJwkKtyEnumValues =
    new BuiltSet<ECJwkKtyEnum>(const <ECJwkKtyEnum>[
  _$eCJwkKtyEnum_EC,
]);
...
final BuiltSet<ECJwkCrvEnum> _$eCJwkCrvEnumValues =
    new BuiltSet<ECJwkCrvEnum>(const <ECJwkCrvEnum>[
  _$eCJwkCrvEnum_n256,
  _$eCJwkCrvEnum_n384,
  _$eCJwkCrvEnum_n521,
]);
...
final BuiltSet<ECJwkUseEnum> _$eCJwkUseEnumValues =
    new BuiltSet<ECJwkUseEnum>(const <ECJwkUseEnum>[
  _$eCJwkUseEnum_sig,
  _$eCJwkUseEnum_enc,
]);

Serializer<ECJwkKtyEnum> _$eCJwkKtyEnumSerializer =
    new _$ECJwkKtyEnumSerializer();
Serializer<ECJwkCrvEnum> _$eCJwkCrvEnumSerializer =
    new _$ECJwkCrvEnumSerializer();
Serializer<ECJwkUseEnum> _$eCJwkUseEnumSerializer =
    new _$ECJwkUseEnumSerializer();
...
class _$ECJwk extends ECJwk {
  ...
  factory _$ECJwk([void Function(ECJwkBuilder)? updates]) =>
      (new ECJwkBuilder()..update(updates))._build();
  ...
  _$ECJwk._(
      ...
      this.x5tHashS256})
      : super._() {
    BuiltValueNullFieldError.checkNotNull(kty, r'ECJwk', 'kty');
    BuiltValueNullFieldError.checkNotNull(crv, r'ECJwk', 'crv');
    BuiltValueNullFieldError.checkNotNull(x, r'ECJwk', 'x');
    BuiltValueNullFieldError.checkNotNull(y, r'ECJwk', 'y');
  }
  ...
  @override
  ECJwkBuilder toBuilder() => new ECJwkBuilder()..replace(this);
    ...
    try {
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'ECJwk', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
