...
class _$JwkSet extends JwkSet {
  ...
  factory _$JwkSet([void Function(JwkSetBuilder)? updates]) =>
      (new JwkSetBuilder()..update(updates))._build();

  _$JwkSet._({required this.keys}) : super._() {
    BuiltValueNullFieldError.checkNotNull(keys, r'JwkSet', 'keys');
  }
  ...
  @override
  JwkSetBuilder toBuilder() => new JwkSetBuilder()..replace(this);
...
class JwkSetBuilder implements Builder<JwkSet, JwkSetBuilder> {
  ...
  ListBuilder<ECJwk> get keys => _$this._keys ??= new ListBuilder<ECJwk>();
  ...
  _$JwkSet _build() {
    _$JwkSet _$result;
    try {
      _$result = _$v ?? new _$JwkSet._(keys: keys.build());
    } catch (_) {
