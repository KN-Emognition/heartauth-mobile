...
class MaterialTheme {
  ...
  static ColorScheme lightMediumContrastScheme() {
    return const ColorScheme(
      ...
      surfaceTint: Color(0xff904a43),
      onPrimary: Color(0xffffffff),
      primaryContainer: Color(0xffa15851),
  ...
  static ColorScheme darkMediumContrastScheme() {
    return const ColorScheme(
      ...
      outlineVariant: Color(0xff9f8c89),
      shadow: Color(0xff000000),
      scrim: Color(0xff000000),
      inverseSurface: Color(0xfff1dedc),
  ...
  static ColorScheme darkHighContrastScheme() {
    return const ColorScheme(
      ...
      secondaryContainer: Color(0xffe3b9b4),
      onSecondaryContainer: Color(0xff190605),
      tertiary: Color(0xffffeed3),
  ...
  static const customColor1 = ExtendedColor(
    seed: Color(0xff2a0a3d),
    value: Color(0xff2a0a3d),
    light: ColorFamily(
      color: Color(0xff735187),
      onColor: Color(0xffffffff),
      colorContainer: Color(0xfff5d9ff),
      onColorContainer: Color(0xff5a396d),
    ),
    ...
    dark: ColorFamily(
      color: Color(0xffe1b8f5),
      onColor: Color(0xff422255),
      colorContainer: Color(0xff5a396d),
      onColorContainer: Color(0xfff5d9ff),
    ),
